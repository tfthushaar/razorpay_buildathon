...
the model. Eighteen incidents with sourced attribution: [WHAT_BROKE.md](WHAT_BROKE.md).
...
Every number here is generated by a committed script and checkable without taking my word for it.
[BUILD_LOG.md](docs/BUILD_LOG.md) is the unedited working journal, kept for provenance rather than offered
as reading.
